...
**Who paid for this token?** I contribute cost attribution logic to AI gateways so the provider bill can answer that. See my work on [agentgateway](https://agentgateway.dev/blog/2026-08-19-invoice-grade-attribution-bedrock), and a public scoreboard of which gateways can, [thegatewaybaseline.com](https://thegatewaybaseline.com).
