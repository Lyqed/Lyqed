...
**Who paid for this token?** I contribute cost attribution to AI gateways so the cloud bill can answer that: [agentgateway](https://agentgateway.dev/blog/2026-08-19-invoice-grade-attribution-bedrock), and a public scoreboard of which gateways can, [the-gateway-baseline.com](https://thegatewaybaseline.com).
